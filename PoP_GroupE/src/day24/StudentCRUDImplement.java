...
public class StudentCRUDImplement implements StudentCRUD {
	...
	public void update(Student student) {
		...
		String strSql = "update tbl_student	set full_name='" + student.getFullName() + "', pop=" + student.getPop()
				+ ", cn=" + student.getCn() + ", db=" + student.getDb() + ", total=" + student.getTotal() + ", average="
				+ student.getAverage() + ", result='" + student.getResult() + "' where sid=" + student.getSid() + ";";
		try {
			// Load the driver
			...
			statement.executeUpdate(strSql);// insert, update, and delete
			statement.close();
			// Close connection
			conn.close();
	...
	public void delete(int sid) {
		String strSql = "delete FROM tbl_student	where sid=" + sid + ";";
		try {
			// Load the driver
			Class.forName(DRIVER);
			// Connect with database
