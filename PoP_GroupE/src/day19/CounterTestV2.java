...
public class CounterTestV2 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		btnClickMe.setOnAction(event->{
			...
			//Send to Process
			MyNumber mn=new MyNumber(tmpNumber);
			mn=new MyCounter().increase(mn);
			
			//Integer to String
			lblValue.setText(Integer.toString(mn.getNum1()));
		});
