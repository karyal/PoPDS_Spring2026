...
public class MyMethods {
	...
	public static void main(String[] args) {
		//Starter method of class
		//System.out.println("Hello from PCPS College-1");
		//main();//call main method
		//main();//call main method
		//f1();//call method - write once; use many
		//f1();
		//f1();
		//f2();//call
		//f3();
	...
	public static void f2() //Name of block is called method
	{//Block Start
