...
public class EditPerson extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ComboBox cmbQuf;
		Button btnSearch, btnClose, btnUpdate;

		lblTitle = new Label("PERSON EDIT FORM");
		...
		btnUpdate.setOnAction(event -> {
			...
			// send to update
			boolean result = new PersonDatabase().update(person);
